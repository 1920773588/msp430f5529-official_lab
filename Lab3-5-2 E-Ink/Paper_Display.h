...
#define nCS_H	P3OUT|=BIT2   //SPI片选引脚，低电平有效
#define nCS_L	P3OUT&=~BIT2
#define SDA_H	P3OUT|=BIT3   //
#define SDA_L	P3OUT&=~BIT3
#define SCLK_H   P2OUT|=BIT7   //SPI通信SCK引脚，通信时钟
#define SCLK_L   P2OUT&=~BIT7
#define nDC_H 	P3OUT|=BIT4    //数据/命令控制引脚，高电平数据，低电平命令
#define nDC_L 	P3OUT&=~BIT4
#define nBUSY	P2IN & BIT2 //高电平表示忙
